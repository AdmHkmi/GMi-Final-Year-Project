...
if ($news_result->num_rows > 0) {
    ...
    while ($news = $news_result->fetch_assoc()) {
        ...
        echo "</div>";
        echo "<p>" . htmlspecialchars($news["NewsContent"]) . "</p>";
        ...
        echo "<div class='form-group'><label>Content:</label><textarea name='content' rows='5' required>" . htmlspecialchars($news["NewsContent"]) . "</textarea></div>";
