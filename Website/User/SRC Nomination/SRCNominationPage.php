...
include 'CheckNominationEvent.php'; // Check for active event
include 'CheckNominationVoteLimit.php'; // Check vote limit
include 'NominationVoteProcess.php'; // Process voting logic
    ...
    <?php if ($event_active): ?>
        <?php if (!$hide_src_container): ?>
            ...
            <script>
                ...
                $voted_candidates_sql = "SELECT CandidateID FROM VSVoteHistory WHERE VoterID = ?";
        ...
        <?php else: ?>
            ...
            <?php include 'NominationVoteHistory.php'; ?>
        <?php endif; ?>
    <?php else: ?>
