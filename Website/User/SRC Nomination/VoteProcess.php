...
if ($loggedInUser) {
    ...
    $stmt_event_limit = $conn->prepare("SELECT VoteLimit FROM VSEvents WHERE EventName = 'Nomination Vote' AND IsActive = 1");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['StudentID'])) {
        ...
        try {
            ...
            $VoteType = "Candidate"; // Set VoteType to "Candidate"
            ...
            if ($_SESSION['NominationVoteLimit'] >= $EventVoteLimit) {
                $hide_src_container = true;
                $vote_message = "You have already casted all of your votes. Thank you for your participation.";
            } else {
