...
// Check for an active event named "Candidate Vote"
$current_date = date('Y-m-d H:i:s');
$check_event_sql = "SELECT EventID FROM VSEvents WHERE EventName = 'Candidate Vote' AND IsActive = 1 AND StartDate <= ? AND EndDate >= ?";
