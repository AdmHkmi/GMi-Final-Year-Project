    ...
    try {
        ...
        $mail->Body    = "
            ...
            <p style='text-align: center;'>
                <a href='http://localhost/Voting System/Website/Register/UserVerificationProcess.php?email=$StudentEmail&token=$token' 
            ...
            <p>Best regards,<br>
            <strong>The GMi Voting System Team</strong></p> 
